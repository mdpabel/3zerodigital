...
const teamMembers = [
  {
    ...
    specialties: ['Web Development', 'Project Management', 'Strategy'],
    social: {
      linkedin: '#',
      twitter: '#',
      github: '#',
  ...
  },
  {
    ...
    specialties: ['UI/UX Design', 'Brand Identity', 'Web Design'],
    social: {
      linkedin: '#',
      behance: '#',
      dribbble: '#',
  ...
  },
  {
    ...
    image: '/api/placeholder/300/300',
    bio: 'Backend specialist focused on performance optimization and security implementation.',
    specialties: ['Backend Development', 'Security', 'Performance'],
    social: {
      linkedin: '#',
      github: '#',
      stackoverflow: '#',
  ...
  },
  {
    ...
    specialties: ['SEO', 'Digital Marketing', 'Analytics'],
    social: {
      linkedin: '#',
      twitter: '#',
      instagram: '#',
